    ...
    if (keys.length === 0 && openRouterKeys.length === 0 && groqKeys.length === 0 && deepInfraKeys.length === 0) {
      return (
        <div className="flex flex-col items-center justify-center p-16 text-center space-y-4">
          ...
          <button onClick={fetchKeyStatus} className="mt-4 px-6 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors flex items-center gap-2 font-medium tracking-wide">
